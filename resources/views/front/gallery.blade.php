...
@section('title', $page->meta_title ?? ($page->title ?? 'Gallery'))
...
@section('content')
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="page-header-box" style="text-align: center; color: white;">
                        <h1 style="color: white; margin-bottom: 15px;">{{ $page->title ?? 'Gallery' }}</h1>
    ...
    @if ($page && $page->content)
        ...
        <div class="gallery-section" style="padding: 80px 0;">
            <div class="container">
                <div class="row">
            ...
            <div class="row align-items-center">
                <div class="col-lg-8">
                    <div class="cta-content" style="color: white;">
                        <h2 style="color: white; margin-bottom: 15px;">Like What You See?</h2>
                        <p style="color: rgba(255,255,255,0.9);">Let's create something amazing for you.</p>
                    </div>
                </div>
                <div class="col-lg-4 text-lg-end">
                    <a href="{{ route('front.contact') }}" class="btn-default"
                        style="background: white; color: #667eea;">Get in Touch</a>
                </div>
            </div>
        </div>
    </div>
