...
@section('title', $page->meta_title ?? ($page->title ?? 'FAQs'))
...
@section('content')
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="page-header-box" style="text-align: center; color: white;">
                        <h1 style="color: white; margin-bottom: 15px;">{{ $page->title ?? 'Frequently Asked Questions' }}
                        </h1>
    ...
    @if ($page && $page->content)
        <!-- FAQs Section Start -->
        <div class="faqs-section" style="padding: 80px 0;">
            <div class="container">
                <div class="row">
            ...
            <div class="row align-items-center">
                <div class="col-lg-8">
                    <div class="cta-content" style="color: white;">
                        ...
                        <p style="color: rgba(255,255,255,0.9);">Feel free to reach out to us anytime.</p>
                    </div>
                </div>
