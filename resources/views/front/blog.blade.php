...
@section('title', $page->meta_title ?? ($page->title ?? 'Blog'))
...
@section('content')
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="page-header-box" style="text-align: center; color: white;">
                        <h1 style="color: white; margin-bottom: 15px;">{{ $page->title ?? 'Blog' }}</h1>
    ...
    @if ($page && $page->content)
        <!-- Blog Section Start -->
        <div class="blog-section" style="padding: 80px 0;">
            <div class="container">
                <div class="row">
            ...
            <div class="row align-items-center">
                <div class="col-lg-8">
                    <div class="cta-content" style="color: white;">
                        <h2 style="color: white; margin-bottom: 15px;">Stay Updated</h2>
                        <p style="color: rgba(255,255,255,0.9);">Subscribe to our newsletter for latest updates.</p>
                    </div>
                </div>
