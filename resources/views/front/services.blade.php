...
@section('title', $page->meta_title ?? ($page->title ?? 'Services'))
...
@section('content')
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="page-header-box" style="text-align: center; color: white;">
                        <h1 style="color: white; margin-bottom: 15px;">{{ $page->title ?? 'Our Services' }}</h1>
    ...
    @if ($page && $page->content)
        ...
        <div class="services-section" style="padding: 80px 0;">
            <div class="container">
                <div class="row">
            ...
            <div class="row align-items-center">
                <div class="col-lg-8">
                    <div class="cta-content" style="color: white;">
                        ...
                        <p style="color: rgba(255,255,255,0.9);">Let's discuss your project requirements.</p>
                    </div>
                </div>
                <div class="col-lg-4 text-lg-end">
                    <a href="{{ route('front.contact') }}" class="btn-default"
                        style="background: white; color: #667eea;">Get Started</a>
                </div>
            </div>
        </div>
    </div>
