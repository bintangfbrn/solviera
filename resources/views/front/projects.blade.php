...
@section('title', $page->meta_title ?? ($page->title ?? 'Projects'))
...
@section('content')
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="page-header-box" style="text-align: center; color: white;">
                        <h1 style="color: white; margin-bottom: 15px;">{{ $page->title ?? 'Our Projects' }}</h1>
    ...
    @if ($page && $page->content)
        ...
        <div class="projects-section" style="padding: 80px 0;">
            <div class="container">
                <div class="row">
            ...
            <div class="row align-items-center">
                <div class="col-lg-8">
                    <div class="cta-content" style="color: white;">
                        <h2 style="color: white; margin-bottom: 15px;">Have a Project in Mind?</h2>
                        <p style="color: rgba(255,255,255,0.9);">Let's make it happen together.</p>
                    </div>
                </div>
                <div class="col-lg-4 text-lg-end">
                    <a href="{{ route('front.contact') }}" class="btn-default"
                        style="background: white; color: #667eea;">Start Project</a>
                </div>
            </div>
        </div>
    </div>
