    ...
    <div class="p-4 mx-auto max-w-screen-2xl md:p-6">
        ...
        <div class="mb-6">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Tambah Halaman Baru</h1>
                    <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Buat halaman konten baru untuk website</p>
                </div>
        ...
        <div class="overflow-hidden rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
            <form action="{{ route('admin.pages.store') }}" method="POST" enctype="multipart/form-data" class="p-6 md:p-8">
                @csrf
                ...
                <div class="mb-8">
                    ...
                    <div class="mb-6">
                        ...
                        <textarea name="excerpt" id="excerpt" rows="3"
                            ...
                            placeholder="Ringkasan singkat halaman">{{ old('excerpt') }}</textarea>
                        @error('excerpt')
                            <p class="mt-1.5 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="content" id="content" rows="10"
                            ...
                            placeholder="Tulis konten lengkap halaman di sini">{{ old('content') }}</textarea>
                        @error('content')
                            <p class="mt-1.5 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="mb-8">
                    ...
                    <div>
                        ...
                        @error('featured_image')
                            <p class="mt-1.5 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                        @enderror
                        <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Format: JPG, PNG, GIF. Max 2MB</p>
                    </div>
                </div>
