    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="sm:flex sm:items-center sm:justify-between mb-6">
            <div>
                ...
                <p class="mt-2 text-sm text-gray-700">Kelola izin akses untuk setiap fitur sistem</p>
            </div>
            ...
            <table class="table-auto w-full">
                <thead>
                    <tr class="bg-gray-100">
                        ...
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-700 uppercase tracking-wider">
                            Description</th>
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-700 uppercase tracking-wider">Roles
                        </th>
                ...
                <tbody>
                    @forelse ($permissions as $permission)
                        <tr class="{{ $loop->even ? 'bg-gray-50' : 'bg-white' }} hover:bg-purple-50 transition">
                            <td class="px-6 py-4 text-sm font-medium text-gray-900 font-mono">{{ $permission->name }}</td>
                            <td class="px-6 py-4 text-sm text-gray-600">{{ $permission->display_name ?? '-' }}</td>
                            <td class="px-6 py-4 text-sm text-gray-600">
                                {{ Str::limit($permission->description ?? '-', 60) }}</td>
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="px-6 py-8 text-center text-gray-500">
                                Tidak ada permission. Klik "Tambah Permission" untuk membuat permission baru.
                            </td>
                        </tr>
                    @endforelse
                </tbody>
