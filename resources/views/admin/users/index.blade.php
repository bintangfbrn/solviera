    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="sm:flex sm:items-center sm:justify-between mb-6">
            <div>
                ...
                <p class="mt-2 text-sm text-gray-700">Kelola pengguna dan role mereka dalam sistem</p>
            </div>
            ...
            <table class="table-auto w-full">
                <thead>
                    <tr class="bg-gray-100">
                        ...
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-700 uppercase tracking-wider">Joined
                        </th>
