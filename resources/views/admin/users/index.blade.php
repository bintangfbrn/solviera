        ...
        <div class="overflow-hidden rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
            ...
            <div
                ...
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Kelola pengguna dan role mereka dalam sistem
                    </p>
                </div>
                    ...
                    <table class="min-w-full">
                        <thead>
                            <tr class="border-b border-gray-100 dark:border-gray-800">
                                ...
                                <th class="px-5 py-3 text-left sm:px-6">
                                    <p class="text-xs font-medium uppercase text-gray-500 dark:text-gray-400">Joined</p>
                                </th>
                                ...
                                <tr class="hover:bg-gray-50 dark:hover:bg-white/5">
                                    ...
                                    <td class="px-5 py-4 text-right sm:px-6">
                                        <div class="flex justify-end gap-2">
                                            ...
                                            @else
                                                <span
                                                    class="inline-flex h-9 w-9 items-center justify-center text-gray-400 cursor-not-allowed"
                            ...
                            @empty
                                <tr>
                                    <td colspan="5" class="px-5 py-8 text-center sm:px-6">
                                        <p class="text-sm text-gray-500 dark:text-gray-400">Tidak ada user. Klik "Tambah
                                            User" untuk membuat user baru.</p>
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
