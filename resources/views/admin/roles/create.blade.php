    ...
    <div class="p-4 mx-auto max-w-screen-2xl md:p-6">
        ...
        <div class="mb-6">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Tambah Role Baru</h1>
                    <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Buat role baru dengan permissions</p>
                </div>
        ...
        <div class="overflow-hidden rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
            <form action="{{ route('admin.roles.store') }}" method="POST" class="p-6 md:p-8">
                @csrf
