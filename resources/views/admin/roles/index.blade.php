    ...
    <div class="p-4 mx-auto max-w-screen-2xl md:p-6">
        ...
        <div class="overflow-hidden rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
            ...
            <div
                ...
                <div>
                    <h3 class="text-lg font-semibold text-gray-800 dark:text-white">Manajemen Role</h3>
                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Kelola role dan izin akses sistem</p>
                </div>
                        ...
                        <thead>
                            <tr class="border-b border-gray-100 dark:border-gray-800">
                                <th class="px-5 py-3 text-left sm:px-6">
                                    <p class="text-xs font-medium uppercase text-gray-500 dark:text-gray-400">Role Name</p>
                                </th>
                                <th class="px-5 py-3 text-left sm:px-6">
                                ...
                                <th class="px-5 py-3 text-left sm:px-6">
                                    <p class="text-xs font-medium uppercase text-gray-500 dark:text-gray-400">Permissions
                                    </p>
                                </th>
                                <th class="px-5 py-3 text-left sm:px-6">
                                    <p class="text-xs font-medium uppercase text-gray-500 dark:text-gray-400">Users</p>
                                </th>
                        ...
                        <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                            @forelse ($roles as $role)
                                <tr class="hover:bg-gray-50 dark:hover:bg-white/5">
                                    ...
                                    <td class="px-5 py-4 sm:px-6">
                                        <p class="text-sm text-gray-600 dark:text-gray-300">{{ $role->display_name ?? '-' }}
                                        </p>
                                    </td>
                                    <td class="px-5 py-4 sm:px-6">
                                        <p class="text-sm text-gray-600 dark:text-gray-300">
                                            {{ Str::limit($role->description ?? '-', 50) }}</p>
                                    </td>
                                    <td class="px-5 py-4 sm:px-6">
                                        <span
                            ...
                            @empty
                                <tr>
                                    <td colspan="6" class="px-5 py-8 text-center sm:px-6">
                                        <p class="text-sm text-gray-500 dark:text-gray-400">Tidak ada role. Klik "Tambah
                                            Role" untuk membuat role baru.</p>
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
